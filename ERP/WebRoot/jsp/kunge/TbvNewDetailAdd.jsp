...
<body>
	<center>
		<form action="" method="post" name="f">
		  ...
		  <!--  职工姓名：<select id="EmpName" name="emp"></select>
							商品名：<select id="GoodsName" name="goods"></select>
...
*/function goUpd(id_key){
	window.showModalDialog("<%=path%>/view_findById.action?goodsId="+id_key,window,"dialogHeight:500px;dialogWidth:600px;")
}
