...
<html>
  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">ERP</span> 
			<a class="header-menu-btn" href="javascript:;"><i class="icon-font">&#xe600;</i></a>
			<ul class="header-bar">
				<li class="header-bar-role"><a href="javascript:;" >系统管理员</a></li>
				<li class="header-bar-nav">
					<a href="javascript:;">admin<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
					<ul class="header-dropdown-menu">
						<li><a href="javascript:;" onclick="goUpd()" >个人信息</a></li>
						<li><a href="javascript:;">切换账户</a></li>
						<li><a href="javascript:;" onclick="execute()">退出</a></li>
					</ul>
				</li>
				<li class="header-bar-nav"> 
  ...
  <script type="text/javascript">
   ...
   alert(id_key);
	window.location.href="<%=path%>/user_findById.action?id="+id_key;
}
  /*左侧菜单点击*/
  function execute(){
			$(document).ready(function(){
			 	//设置提交的路径，和参数
				$.post("<%=path %>/user_execute.action",
				function(data){//action执行完之后执行方法，data表示的servlet返回数据内容
	 				if( "true" ==data){
...
$(function(){
	...
	var menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"3","name":"超级管理员","parentId":"1","url":"","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
						{"id":"4","name":"职工管理","parentId":"3","url":"test1.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"6","name":"订单管理","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
						{"id":"7","name":"出库管理","parentId":"6","url":"<%=path%>/jsp/kunge/SaleQuery.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"8","name":"结算","parentId":"6","url":"<%=path%>/page/SaleQuery.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"9","name":"销售部","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
						{"id":"10","name":"销售管理","parentId":"9","url":"<%=path%>/jsp/buyAndSale/SaleQuery.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"11","name":"客户管理","parentId":"9","url":"<%=path%>/jsp/buyAndSale/ClientQuery.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"12","name":"采购部","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
						{"id":"10","name":"商品管理","parentId":"12","url":"<%=path%>/jsp/buyAndSale/GoodsQuery.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"11","name":"供应商管理","parentId":"12","url":"<%=path%>/jsp/buyAndSale/SupplierQuery.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"13","name":"仓管部","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
						{"id":"14","name":"库存维护","parentId":"13","url":"<%=path%>/jsp/kunge/CheckTableQuery.jsp","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"15","name":"商品库存明细","parentId":"13","url":"<%=path%>/jsp/kunge/TbvNewDetailAdd.jsp","icon":"","order":"1","isHeader":"0","childMenus":""}
					]}
				]},
